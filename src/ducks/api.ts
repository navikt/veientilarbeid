...
export const AIA_BACKEND = aiaBackendUrl,
    ...
    ARBEIDSOKERPERIODER_URL = `${AIA_BACKEND}/arbeidssokerregisteret/arbeidssokerperioder`,
    OPPLYSNINGER_OM_ARBEIDSSOKER_URL = `${AIA_BACKEND}/arbeidssokerregisteret/opplysninger-om-arbeidssoker`,
    PROFILERING_URL = `${AIA_BACKEND}/arbeidssokerregisteret/profilering`;
