...
export const AIA_BACKEND = aiaBackendUrl,
    ...
    ARBEIDSOKERPERIODER_URL = `${AIA_BACKEND}/arbeidssokerregisteret/v1/arbeidssokerperioder`,
    OPPLYSNINGER_OM_ARBEIDSSOKER_URL = `${AIA_BACKEND}/arbeidssokerregisteret/v1/opplysninger-om-arbeidssoker`,
