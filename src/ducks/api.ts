...
export const VEILARBOPPFOLGING_URL = `${contextpath}/veilarboppfolging/api/oppfolging`,
    ...
    PAABEGYNTE_SOKNADER_URL = `/saksoversikt-api/tjenester/saker/hentPaabegynteSoknader`,
    MULIGE_ETTERSENDELSER_URL = `/saksoversikt-api/tjenester/ettersendelser/mulige`,
    SAKSTEMA_URL = `/saksoversikt-api/tjenester/sakstema`,
