...
describe('createTriggerType returnerer forventede verdier', () => {
  it('returnerer vta-eksperiment for standalone, kss og eksperiment', () => {
    ...
    expect(createTriggerType(stateMicroFrontend, PoaGruppe, isExperiment)).toBe('vta-eksperiment');
  });
  ...
  it('returnerer vta-dittnav-eksperiment for dittNav, kss og eksperiment', () => {
    ...
    const PoaGruppe = 'kss'
    const isExperiment = true
    expect(createTriggerType(stateMicroFrontend, PoaGruppe, isExperiment)).toBe('vta-dittnav-eksperiment');
  });
  ...
  it('returnerer vta-dittnav-kss for dittNav, kss og ikke eksperiment', () => {
    ...
    expect(createTriggerType(stateMicroFrontend, PoaGruppe, isExperiment)).toBe('vta-dittnav-kss');
  });
  ...
  it('returnerer vta-dittnav-boo for dittNav, boo og ikke eksperiment', () => {
    ...
    const PoaGruppe = 'boo'
    const isExperiment = false
    expect(createTriggerType(stateMicroFrontend, PoaGruppe, isExperiment)).toBe('vta-dittnav-boo');
  });
  ...
  it('returnerer vta-boo for standalone, boo og ikke eksperiment', () => {
    ...
    const PoaGruppe = 'boo'
    const isExperiment = false
    expect(createTriggerType(stateMicroFrontend, PoaGruppe, isExperiment)).toBe('vta-boo');
  });
  ...
  it('returnerer vta-kss for standalone, kss og ikke eksperiment', () => {
    ...
    const PoaGruppe = 'kss'
    const isExperiment = false
    expect(createTriggerType(stateMicroFrontend, PoaGruppe, isExperiment)).toBe('vta-kss');
  });
});
