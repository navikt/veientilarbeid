...
export const dagpengerSoknadLenke = 'https://www.nav.no/dagpenger/dialog/soknad';
export const dagpengerStartSoknadLenke = 'https://www.nav.no/dagpenger/dialog/soknad';
