...
export const AmplitudeProvider = (props: { children: React.ReactNode }) => {
    ...
    const foreslattInnsatsgruppeOrIngenVerdi = brukerregistreringData?.registrering.profilering?.innsatsgruppe || 'INGEN_VERDI';
    ...
    return <AmplitudeAktivitetContext.Provider value={amplitudeAktivitetsData}>
        {props.children}
