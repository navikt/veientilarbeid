    ...
    return (
        <div className="kortflate">
            <div>
                ...
                <BodyShort>
                    As a rule of thumb, NAV will not make contact with you during the first 12 weeks after you
    ...
    return (
        <div className="kortflate">
            <div>
                ...
                <BodyShort className={'blokk-xs'}>
                    You can get help from a counselor before 12 weeks have passed.
                </BodyShort>
