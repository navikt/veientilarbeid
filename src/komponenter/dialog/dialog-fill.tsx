            ...
            <div className="notification">
                ...
                >
                    <svg x="0" y="8">
                        <path
                            fill="#0067C5"
                            d="M16.5,8.75c0.476,0,0.941,0.045,1.399,0.115C17.964,8.486,18,8.094,18,7.685c0-4.1-4.038-7.435-9-7.435
                        ...
                        <path
                            fill="#0067C5"
                            d="M16.5,9.75c-4.065,0-7.5,2.977-7.5,6.5c0,3.355,2.878,6.224,6.434,6.572c0.001,0,0.004,0,0.006,0.002
                    ...
                    <text x={xPos} y="14.4" fill="#ffffff" opacity="1">
